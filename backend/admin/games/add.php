...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        $query = "INSERT INTO games (name, developer, genre, description, cover_image, release_date) 
                  VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssssss", $name, $developer, $genre, $description, $image_name, $release_date);
